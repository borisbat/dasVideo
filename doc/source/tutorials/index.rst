...
library to show the same API decoding AV1 + WebM + Opus; 07 plays a clip as an
animated texture on a spinning 3D cube, straight from an in-memory buffer. Every
step is fronted by **Emma** — each tutorial is voiced, and she walks through it as
the code runs.
